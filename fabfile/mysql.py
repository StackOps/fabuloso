...
def setup_schema(drop_schema, password, root_pass, schema,
                 username, mysql_host):
    if drop_schema:
...
@task
def configure_nova(root_pass, drop_schema=False, schema='nova',
                   username='nova', password='stackops', mysql_host=None):

    setup_schema(drop_schema, password, root_pass, schema, username,
                 mysql_host)


@task
def configure_glance(root_pass, drop_schema=False, schema='glance',
                     username='glance', password='stackops', mysql_host=None):
...
@task
def configure_keystone(root_pass, drop_schema=False, schema='keystone',
                       username='keystone', password='stackops',
                       mysql_host=None):
    setup_schema(drop_schema, password, root_pass, schema, username,
                 mysql_host)
...
@task
def configure_portal(root_pass, drop_schema=False, schema='portal',
                     username='portal', password='stackops', mysql_host=None):
    setup_schema(drop_schema, password, root_pass, schema, username,
                 mysql_host)


@task
def configure_quantum(root_pass, drop_schema=False, schema='quantum',
                      username='quantum', password='stackops',
                      mysql_host=None):
    setup_schema(drop_schema, password, root_pass, schema, username,
                 mysql_host)
...
@task
def configure_cinder(root_pass, drop_schema=False, schema='cinder',
                     username='cinder', password='stackops', mysql_host=None):
...
@task
def configure_accounting(root_pass, drop_schema=False, schema='accounting',
                         username='accounting', password='stackops',
                         mysql_host=None):
